...
const ThemeSelectedMaterialUIComponent = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-thumb': {
    backgroundColor: theme.palette.mode === 'dark' ? '#f06292' : '#616161',
    '&::before': {
      content: "''",
      position: 'absolute',
      width: '100%',
